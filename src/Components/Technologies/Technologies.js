...
const Technologies = () => {
    return (
        <div className='px-8 tech_div pb-20'>
            <h2 style={{ color: "#ed9d7b" }} className='text-4xl font-bold underline mt-20 mb-16 pt-16'>Technologies</h2>

            {/* ---------------------Carousel------------------- */}
            <div className="carousel h-72 md:h-96 py-4 lg:hidden">
